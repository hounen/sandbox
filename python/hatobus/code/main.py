...
class Main(Base):
    def __init__(self):
        ...
        # 出力先
        self.output_base = os.path.join(self.config['OPTION']['OUTPUT_PLACE_PATH'], f"hatobus_{self.run_time}")
    ...
    def search(self):
        url = self.config['HATOBUS_SOURCE']['url']
        url += "?" + "courseCategory=" + self.config['HATOBUS_SOURCE']['courseCategory']
        url += "&" + "departureFrom=" + self.config['HATOBUS_SOURCE']['departureFromYear'] + "%2F" + self.config['HATOBUS_SOURCE']['departureFromMonth'] + "%2F" + self.config['HATOBUS_SOURCE']['departureFromDay']
        url += "&" + "departureTo=" + self.config['HATOBUS_SOURCE']['departureToYear'] + "%2F" + self.config['HATOBUS_SOURCE']['departureToMonth'] + "%2F" + self.config['HATOBUS_SOURCE']['departureToDay']
        url += "&" + "searchCarryOutConfirmedFlag=" + self.config['HATOBUS_SOURCE']['searchCarryOutConfirmedFlag']
        url += "&" + "minEstimateFare=" + self.config['HATOBUS_SOURCE']['minEstimateFare']
        url += "&" + "maxEstimateFare=" + self.config['HATOBUS_SOURCE']['maxEstimateFare']
        url += "&" + "vacantCount=" + self.config['HATOBUS_SOURCE']['vacantCount']
        url += "&" + "dayCourseFlag=" + self.config['HATOBUS_SOURCE']['dayCourseFlag']
        url += "&" + "departurePlaceId=" + self.config['HATOBUS_SOURCE']['departurePlaceId']
        url += "&" + "recordCount=" + self.config['HATOBUS_SOURCE']['recordCount']
