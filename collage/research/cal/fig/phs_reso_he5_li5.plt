...
set output "phs_reso_he5_li5.eps"
p "../helium5/phs/allphs/allphs_p1_100MeV.d"\
  u 1:3 t "^5He p_{1/2} conti" w l lw 6.0 ,\
  "../helium5/phs/allphs/allphs_p3_100MeV.d"\
  u 1:3 t "^5He p_{3/2} conti" w l lw 6.0 ,\
  "../lithium5/phs/data/analysis/phs_ana_p1.d"\
  u 1:3 t "^5Li p_{1/2} conti" w l lw 6.0 ,\
  "../lithium5/phs/data/analysis/phs_ana_p3.d"\
  u 1:3 t "^5Li p_{3/2} conti" w l lw 6.0
