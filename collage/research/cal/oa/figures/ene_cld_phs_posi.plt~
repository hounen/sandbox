...
set output "ene_cld_phs_posi.ps"
set xrange[0:20]
set multiplot
...
set label "K^{/Symbol p}=0_{4}^{+} J^{/Symbol p}=0^{+} E_{r}=3.23MeV {/Symbol G}=1.79MeV" at 10,340 center
...
set rmargin 0
set lmargin 0
p "../phs/data/analysis/phs_k4_j0.d" u 1:($2+180) w l t "" lt 3 lw 3
...
unset ylabel
unset label
set label "K^{/Symbol p}=0_{4}^{+} J^{/Symbol p}=2^{+} E_{r}=4.21MeV {/Symbol G}=2.73MeV" at 10,340 center
...
#set noy2tics
unset label
set label "K^{/Symbol p}=0_{4}^{+} J^{/Symbol p}=4^{+} E_{r}=6.63MeV {/Symbol G}=4.48MeV" at 10,340 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.4,0.7
set size 0.2,0.3
set tmargin 0
...
#set noy2tics
unset label
set label "K^{/Symbol p}=0_{1}^{+} J^{/Symbol p}=6^{+} E_{r}=3.72MeV {/Symbol G}=0.002MeV" at 10,340 center
set label "K^{/Symbol p}=0_{4}^{+} J^{/Symbol p}=6^{+} E_{r}=10.9MeV {/Symbol G}=6.62MeV" at 10,310 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.6,0.7
set size 0.2,0.3
set tmargin 0
...
#set noy2tics
unset label
set label "K^{/Symbol p}=0_{1}^{+} J^{/Symbol p}=8^{+} E_{r}=9.87MeV {/Symbol G}=0.02MeV" at 10,340 center
set label "K^{/Symbol p}=0_{4}^{+} J^{/Symbol p}=8^{+} E_{r}=17.35MeV {/Symbol G}=8.10MeV" at 10,310 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.8,0.7
set size 0.2,0.3
set tmargin 0
...
set rmargin 0
set lmargin 0
p "../cld/data/cld_k4_j0.d" u 1:2 t "" w l lt 3  lw 3
