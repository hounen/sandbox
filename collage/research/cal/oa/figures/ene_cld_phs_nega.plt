...
set output "ene_cld_phs_nega.ps"
set xrange[0:20]
set multiplot
...
set label "K^{/Symbol p}=0_{1}^{-} J^{/Symbol p}=1^{-} E_{r}=0.49MeV {/Symbol G}=1.68*10^{-4}MeV" at 10,340 center
...
set rmargin 0
set lmargin 0
p "../phs/data/analysis/phs_k1_j1.d" u 1:2 w l t "" lt 3 lw 3
...
unset ylabel
unset label
set label "K^{/Symbol p}=0_{1}^{-} J^{/Symbol p}=3^{-} E_{r}=2.31MeV {/Symbol G}=0.01MeV" at 10,340 center
...
unset ylabel
unset label
set label "K^{/Symbol p}=0_{1}^{-} J^{/Symbol p}=5^{-} E_{r}=5.64MeV {/Symbol G}=0.3MeV" at 10,340 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.4,0.7
set size 0.2,0.3
set tmargin 0
...
unset ylabel
unset label
set label "K^{/Symbol p}=0_{1}^{-} J^{/Symbol p}=7^{-} E_{r}=10.88MeV {/Symbol G}=1.04MeV" at 10,340 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.6,0.7
set size 0.2,0.3
set tmargin 0
...
unset ylabel
unset label
set label "K^{/Symbol p}=0_{1}^{-} J^{/Symbol p}=9^{-} E_{r}=18.74MeV {/Symbol G}=1.72MeV" at 10,340 center
set label "K^{/Symbol p}=0_{*}^{-} J^{/Symbol p}=9^{-} E_{r}=23.70MeV {/Symbol G}=18.94MeV" at 10,310 center
#set label "{/Symbol d}" at 4.5,150 center font "Times,15"
set origin 0.8,0.7
set size 0.2,0.3
set tmargin 0
...
set rmargin 0
set lmargin 0
p "../cld/data/cld_k1_j1.d" u 1:2 t "" w l lt 3  lw 3
